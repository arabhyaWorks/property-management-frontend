  ...
  return (
    <div className="rounded-lg mx-auto">
      ...
      <div className="bg-white text-black p-4 rounded-lg shadow-md mb-4">
        <p className="mb-1"><strong>मूल राशि:</strong> {baseAmount.toFixed(2)}</p>
        <p className="mb-1"><strong>विलंब शुल्क:</strong> {lateFee.toFixed(2)}</p>
        <p className="text-lg font-semibold"><strong>कुल:</strong> {total.toFixed(2)}</p>
      </div>
