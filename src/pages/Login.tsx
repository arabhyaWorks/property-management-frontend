...
export function Login() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await fetch(`${newBaseEndpoint}/api/users/login/otp/send`, {
        method: 'POST',
        headers: {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      const response = await fetch(`${newBaseEndpoint}/api/users/login/otp/verify`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleAdminLogin = async (e) => {
    ...
    try {
      const response = await fetch(`${newBaseEndpoint}/api/users/login/password`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
