...
const PaymentCounterServiceCharges: React.FC = () => {
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <p className="text-sm text-gray-600">
                    ...
                    <span className="font-semibold">
                      {propertyRecord.property_floor_type}
                    </span>
                  </p>
              ...
              {selectedYears.length > 0 && (
                <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                  ...
                  <div className="bg-gray-50 p-5 rounded-xl border border-gray-100 mb-6">
                    ...
                    <div className="mt-4 pt-4 border-t-2 border-gray-200">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="text-right font-medium">
                          ₹
                          {paymentBreakdown.totalLateFees.toLocaleString(
                            "en-IN"
                          )}
                        </div>
                      </div>
                  ...
                  >
                    {isLoading
                      ? "Processing..."
                      : `Pay Service Charges (₹${paymentBreakdown.grandTotal.toLocaleString(
                          "en-IN"
                        )})`}
                  </button>
                </div>
...
export default PaymentCounterServiceCharges;
