...
function PaymentCounterEMIPayment() {
              ...
              <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg border border-blue-100 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 mt-1">
                    ...
                    per day will be charged after the due date. Please ensure
...
export default PaymentCounterEMIPayment;
